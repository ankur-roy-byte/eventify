...
public class InventoryWorkerApplication {
        ...
        private static final String INVENTORY_RESERVED_SCHEMA =
                        "{\"type\":\"record\",\"name\":\"InventoryReserved\",\"namespace\":\"com.example.events.inventory.v1\"," +
                                        "\"fields\":[{\"name\":\"order_id\",\"type\":\"string\"},{\"name\":\"inventory_status\",\"type\":\"string\"}," +
                                        "{\"name\":\"reserved_at\",\"type\":\"string\"}]}";
    ...
    public static void main(String[] args) {
        ...
        consumerProps.put(ConsumerConfig.GROUP_ID_CONFIG, "inventory-worker");
        ...
        producerProps.put(ProducerConfig.TRANSACTIONAL_ID_CONFIG, "inventory-worker-tx-v1");
        producerProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class.getName());
        producerProps.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, KafkaAvroSerializer.class.getName());
        producerProps.put("schema.registry.url", schemaRegistry);

        Schema inventorySchema = new Schema.Parser().parse(INVENTORY_RESERVED_SCHEMA);
            ...
            while (true) {
                ...
                try {
                    ...
                    for (ConsumerRecord<String, GenericRecord> record : records) {
                        ...
                        GenericRecord inventoryReserved = new GenericData.Record(inventorySchema);
                        inventoryReserved.put("order_id", orderId);
                        inventoryReserved.put("inventory_status", "RESERVED");
                        inventoryReserved.put("reserved_at", Instant.now().toString());

                        producer.send(new ProducerRecord<>("inventory.v1.events", orderId, inventoryReserved));
                        offsets.put(
